...
export default function EditPaymentDialog({
  ...
  const [state, formAction, isPending] = useActionState(updatePaymentAction, {
    success: "",
    error: "",
  });
  ...
  useEffect(() => {
    if (isOpen && payment) {
      setFormData({
        ...
        work_order_code: payment.work_order_code || "",
        ...
        voucher_file_url: payment.voucher_file_url || "",
        file_name: payment.voucherFile?.file_name || "",
        file_size: payment.voucherFile?.file_size || 0,
      });
      setPdfFile(null);
    }
  }, [isOpen, payment]);
    ...
    try {
      ...
      if (res.error || !res.uploadedFile) {
        ...
        toast({
          ...
          description: "New voucher PDF file uploaded to Cloudinary successfully.",
        });
      }
    } catch (err: any) {
      toast({
      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
          ...
          onSubmit={(e) => {
            if (!formData.voucher_file_url) {
              ...
              toast({
                ...
                description: "Please upload the voucher PDF document before saving.",
                variant: "destructive",
              });
            }
          }}
        >
          ...
          <div className="space-y-3 pt-2 border-t border-gray-100">
            ...
            {/* Voucher PDF Upload / Replace (Mandatory) */}
            <div className="mt-3">
                  ...
                  <div className="flex items-center gap-2.5 overflow-hidden">
                    ...
                    <div className="overflow-hidden">
                      <p className="text-xs font-bold text-[#1a2b3c] truncate">
                        {formData.file_name || pdfFile?.name || "Voucher Document"}
                      </p>
