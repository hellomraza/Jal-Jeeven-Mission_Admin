      ...
      <div className="space-y-6">
        ...
        <Alert className="border-blue-200 bg-blue-50">
          ...
          <AlertDescription className="text-blue-900">
            {parsedData.length} agreement(s) found. Please verify the data
            before importing.
          </AlertDescription>
        </Alert>
    ...
    <div className="space-y-6">
      ...
      <Card className="border-none shadow-[0_4px_24px_rgba(0,0,0,0.02)] bg-white rounded-2xl">
        <CardHeader className="pb-3">
          ...
          <CardDescription>
            Select an .xlsx file to upload. The file will be parsed and
            displayed for verification before import.
          </CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Alert className="border-amber-200 bg-amber-50">
        ...
        <AlertDescription className="text-amber-900">
          The file will be validated and parsed on the server. Any errors in the
          Excel format will be reported after upload.
        </AlertDescription>
      </Alert>
    </div>
  );
